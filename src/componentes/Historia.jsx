...
function Historia({setActiveTab}){
  return(
    <section>
      ...
      <div className="card">
        <img src="/src/images/PrimeraComision.jpeg" alt="Fundacion"/>
        <img src="/src/images/PrimeraComision2.jpeg" alt="Fundacion"/>
      ...
      <div className="card">
        <img src="/src/images/cuartel1.jpeg" alt="Fundacion"/>
        <img src="/src/images/cuartel2.jpeg" alt="Fundacion"/>
        <img src="/src/images/cuartel3.jpeg" alt="Fundacion"/>
      ...
      <div className="card">
        <img src="/src/images/movil2.jpeg" alt="Fundacion"/>
        <img src="/src/images/movil4.jpeg" alt="Fundacion"/>
        <p>
